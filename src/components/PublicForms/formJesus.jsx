...
const StudentRegistrationFormJesus = ({ onStudentAdded }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <div className="bg-orange-100 rounded-t-lg p-6 border-b-8 border-orange-500">
...
export default StudentRegistrationFormJesus;